...
var tilesUrl = "./bohemia_8192/{z}_{x}_{y}.jpg";
var maxNativeZoom = 5;
var mapMinZoom = 1;
var mapMaxZoom = 6;
...
map.setMaxBounds([[-11000, -11000], [11000, 11000]]);
...
for (var i = 0; i < markers.length; i++) {
  ...
  var marker = L.marker([x/4096 *7816 -3908, y/4096 *7816 -3908], {icon: getIcon(i)}).bindPopup("<p class='mtitle'>"+markers[i].name + "</p><span class='mdesc'>"+ markers[i].desc +"</span><ul class='ilist'>"+ilist+"</ul><p class='original_coords'>"+origin_y+","+origin_x+"</p>").addTo(layerGroups[markers[i].group]);
}
